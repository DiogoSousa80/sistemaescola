...
public class Disciplina {
    ...
    public boolean equals(Object o) {
        ...
        return Double.compare(that.getNota1(), getNota1()) == 0 && Double.compare(that.getNota2(), getNota2()) == 0 && Double.compare(that.getNota3(), getNota3()) == 0 && Double.compare(that.getNota4(), getNota4()) == 0 && Objects.equals(getDisciplina1(), that.getDisciplina1()) && Objects.equals(getDisciplina2(), that.getDisciplina2()) && Objects.equals(getDisciplina3(), that.getDisciplina3()) && Objects.equals(getDisciplina4(), that.getDisciplina4());
    }
